# ｽﾀｯｸﾁｬﾝ Android Local Voice Dock App

Android端末をｽﾀｯｸﾁｬﾝの頭脳として、完全ローカルの日本語音声会話を動かすdock appです。
...
通信仕様と障害時の確認方法は[USB CDC v2 contract](../../contracts/usb-cdc-v2/README.md)を参照してください。
