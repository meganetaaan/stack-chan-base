...
required = [
    ...
    "app/src/main/java/jp/stackchan/localvoicepoc/conversation/AdaptiveNoiseGate.kt",
    ...
    "app/src/main/java/jp/stackchan/localvoicepoc/serial/ConnectionGenerationGate.kt",
